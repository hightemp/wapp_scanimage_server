...
const tabs: { id: TabType; label: string; icon: string }[] = [
  { id: 'scans', label: 'Scans', icon: 'M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z' },
  ...
  <aside class="w-full lg:w-64 bg-white dark:bg-gray-800 shadow-lg flex flex-col">
    ...
    <div class="p-4 border-t border-gray-200 dark:border-gray-700 hidden lg:block">
      ...
      >
        ...
        <span>{{ store.isDarkMode ? 'Light Theme' : 'Dark Theme' }}</span>
      </button>
    </div>
  </aside>
</template>
